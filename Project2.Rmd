...
## Comparison
I will now compare our four models directly in order to declare a "winner," that is the model that has the (insert metric here). 
```{r}
prediction1 <- predict(model_1, newdata = daydataTest)
prediction2 <- predict(model_2, newdata = daydataTest2)

rmse(prediction1, daydataTest$cnt)
rmse(prediction2, daydataTest2$cnt)
```
